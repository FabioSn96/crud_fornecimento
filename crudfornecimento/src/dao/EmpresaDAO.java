...
public class EmpresaDAO {
    ...
    public void cadastrarEmpresa(EmpresaDTO objempresadto) {
        ...
        String sql = "insert into tb_empresas (cpnj_empresa, nome_empresa, cep_empresa, id_fornecedor, nome_fornecedor) values (?, ?, ?, ?, ?)";
        ...
        try {
            ...
            pstm.setString(5, objempresadto.getNome_fornecedor());
    ...
    public ArrayList<EmpresaDTO> PesquisarEmpresa() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                objempresadto.setNome_fornecedor(rs.getString("nome_fornecedor"));
